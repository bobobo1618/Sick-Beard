...
class Quality:                                                        
    ...
    def sceneQuality(name):
        ...
        elif checkName(["720p", "web.dl", "h.?264"], all) or checkName(["720p", "itunes", "h.?264"], all) or checkName(["720p", "web-dl", "x264"], all):
            return Quality.HDWEBDL                                                                     
        elif checkName(["1080p", "web.dl", "h.?264"], all) or checkName(["1080p", "itunes", "h.?264"], all) or checkName(["1080p", "web-dl", "x264"], all):     
